...
const pagination_cursor_number_util_1 = require("../../../utils/paginations/pagination-cursor-number.util");
const models_1 = require("../../models");
let NearbyProfilesService = class NearbyProfilesService extends api_read_base_service_1.ApiReadService {
    constructor(profileModel, profileFilterModel, profilesUtil, paginationUtil) {
        super();
    ...
    async findMany(queryParams, client) {
        ...
        const minDistance = (_next ? this.paginationUtil.getCursor(_next) : 0) + 0.00000000001;
...
NearbyProfilesService = __decorate([
    ...
    __metadata("design:paramtypes", [models_1.ProfileModel,
        ...
        pagination_cursor_number_util_1.PaginationCursorNumberUtil])
