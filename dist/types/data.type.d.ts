import { DEVICE_PLATFORMS, EDUCATION_LEVELS, GENDERS, MEDIA_FILE_TYPES, MEMBERSHIPS, RELATIONSHIP_GOALS, RELATIONSHIP_STATUSES, RESPONSE_TYPES, USER_ROLES, USER_STATUSES, WEEKLY_COINS } from '../constants/data.constant';
